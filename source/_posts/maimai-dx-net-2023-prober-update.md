...
{%image https://imgsrc.chyk.ink/2cf5e0fe9925bc310d4530571bdf8db1ca1370e0.webp height:12rem %}
...
{%image https://imgsrc.chyk.ink/b64543a98226cffca9288e7dfc014a90f703eafb.webp height:12rem %}

现在它是这个样子的：

{%image https://imgsrc.chyk.ink/5fdf8db1cb1349545e1ad9ab134e9258d0094afc.webp height:12rem %}
...
{%image https://imgsrc.chyk.ink/810a19d8bc3eb135569d8674e31ea8d3fc1f44a2.webp %}

然后在手机上依次点开「记录」-「乐曲成绩」，选择一个难度，然后**拼命往下滑**直到滑到底为止。

{%image https://imgsrc.chyk.ink/4d086e061d950a7bda657f0b4fd162d9f3d3c9a9.webp height:40rem %}

确认滑到底后，在电脑上点击 inspect 打开调试器，右键选中 `<html lang="zh">` 标签之后点击「以 HTML 格式修改」，复制其中的全部源码。

{%image https://imgsrc.chyk.ink/d4628535e5dde711d0987239e2efce1b9c1661b2.webp height:15rem %}

前往 [查分器官网](https://www.diving-fish.com/maimaidx/prober/) 点击「导入数据」，粘贴源码即可导入。

{%image https://imgsrc.chyk.ink/0df431adcbef7609604aa8506bdda3cc7dd99ebf.webp %}

如果需要导入多个难度的分数，重复上述操作即可。

---

{%image https://imgsrc.chyk.ink/d50735fae6cd7b89052e0b4c4a2442a7d8330eba.webp 我目前的 b50，有没有大佬浇浇 QAQ %}